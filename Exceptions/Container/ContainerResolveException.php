...
class ContainerResolveException extends BaseException implements ExceptionInterface, ContainerExceptionInterface
{
    public function __construct(
        string $message = 'Error trying to resolve item',
