...
/**
 * Enum equivalent of HttpStatusInterface.
 *
...
enum HttpStatus: int implements HttpStatusClassInterface, HttpStatusReasonPhraseInterface
{
    ...
    public static function fromReasonPhrase(string $phrase): static
    {
        ...
        throw new UnrecognizedReasonPhraseException("Reason phrase '{$phrase}' not found.");
    }
    ...
    public static function tryFromReasonPhrase(string $phrase): ?static
    {
        ...
        } catch (UnrecognizedReasonPhraseException) {
            return null;
        }
